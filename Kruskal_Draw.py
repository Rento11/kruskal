...
with open(r'C:\Users\RENTO\Desktop\Recherche_Opérationnelle\Kruskal_data.txt', 'r') as file:
    text1 = file.read()

with open(r'C:\Users\RENTO\Desktop\Recherche_Opérationnelle\Kruskal_MST.txt', 'r') as file:
    text2 = file.read()
